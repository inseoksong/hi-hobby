...
<link rel="stylesheet" href="myCoupons101.css">
			...
			<div class="wrapper2">
				...
				<div class="kgBzKM">
					<div class="ihVMlk">
						...
						<div class="dybKLf">
							<div fill="true" class="kSXYcU hVvVYd">
								<div class="dGxueP iinfVf">
									<input class="eQAnnk iinfVf" type="text" name="couponCode" autocomplete="off" placeholder="할인 쿠폰 코드를 입력해주세요." value>
								</div>
								<div class="css-dnovcd"></div>
								<button class="gQyJNI bQeqNr fjbmsx" type="button" color="orange" fill="false">
									<span class="jwNHGa">등록하기</span>
								</button>
							</div>
						</div>
						<div class="bDnlSL">
