		...
		<div class="container-wrap">
			<div class="container">
				<div class="class-wrap">
					<c:forEach var="classs" items="${selectDetail}">
						<div class="class-image">
							...
							<div class="images">
								<div class="image">
									<c:out value="${classs.getClassImg()}"></c:out>
								</div>
							</div>
						...
						<div class="class-buy">
							<div class="sticky">
								<div class="class-explan">
									...
									<div class="class-crea"><c:out value="${classs.getClassNickname()}"/></div>
									<div class="class-price"><c:out value="${classs.getClassPrice()}"/></div>
								</div>
											...
											<form action="OrderCreateOne.or" name="createOneForm" method="post" onsubmit="orderCheck()">
												...
												<div class="amount-of-payment">
													...
													<div class="payment-price">
														<p>총 상품 금액</p>
														<p><c:out value="${classs.getClassPrice()}"/></p>
													</div>
								...
								<div class="class">
									<section>
										...
										<div class="writing">
											<div class="folded">
												<div class="main-text">
												<c:out value="${classs.getClassIntroduce()}"/>
								...
								<div class="creator">
									<div class="creator-wrap">
										<div class="creator-profile">
											<h3><c:out value="${classs.getClassNickname()}"/></h3>
								...
								<div class="detail">
									...
									<div class="detail-wrap">
										<div class="detail-product">
											...
											<p class="answer"><c:out value="${classs.getclassOne()}"/></p>
										</div>
										<div class="detail-category">
											<p class="question">카테고리</p>
											<p class="answer"><c:out value="${classs.getclassCategory()}"/></p>
										</div>
									</div>
									<div class="detail-wrap">
										<div class="detail-location">
											<p class="question">위치</p>
											<p class="answer"><c:out value="${classs.getclassPlace()}"/></p>
										</div>
										<div class="detail-time">
											<p class="question">시간</p>
											<p class="answer"><c:out value="${classs.getclassStart()}"/></p>
										</div>
									</div>
								</div>
							</article>
