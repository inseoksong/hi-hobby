					...
					<div class="class-buy">
						<div class="sticky">
							...
							<div class="reservation-button">
								<button type="button" onclick="location.href='onedayPayment.jsp'">클래스 예약하기</button>
							</div>
							...
							<div class="detail">
								...
								<div class="detail-wrap">
									<div class="detail-location">
										...
										<p class="answer">서울시 관악구 봉천동</p>
									</div>
									<div class="detail-time">
										<p class="question">시간</p>
										<p class="answer">총 1시간 30분</p>
									</div>
								</div>
							</div>
						</article>
