							...
							<div class="css-1dkc3tl">
								<div class="css-1q7ezph">
									<div class="css-zsoya5">
										...
										<div class="css-165esj4 3" onclick="notice(3)"
											onmouseout="this.style.background='#ffffff'"
											onmouseover="this.style.background='rgb(248, 248, 248)';">
											<div class="css-1f8m7mx">
												<div class="css-1m6hr3p">
													<span class="css-l67hwq"><svg
															...
															class="css-skwyyj">
                                                                <path
																d="M8.298 4.5v3.75h-3.75V4.5h3.75Zm2.2-2.5h-8.2c-.15 0-.3.15-.3.3v8.2c0 .15.15.3.3.3h8.2c.15 0 .3-.15.3-.3V2.3c0-.15-.15-.3-.3-.3ZM19.502 4.5v3.75h-3.75V4.5h3.75Zm2.2-2.5h-8.2c-.15 0-.3.15-.3.3v8.2c0 .15.15.3.3.3h8.2c.15 0 .3-.15.3-.3V2.3c0-.15-.15-.3-.3-.3ZM8.298 15.7v3.75h-3.75V15.7h3.75Zm2.2-2.5h-8.2c-.15 0-.3.15-.3.3v8.2c0 .15.15.3.3.3h8.2c.15 0 .3-.15.3-.3v-8.2c0-.15-.15-.3-.3-.3ZM19.502 15.7v3.75h-3.75V15.7h3.75Zm2.2-2.5h-8.2c-.15 0-.3.15-.3.3v8.2c0 .15.15.3.3.3h8.2c.15 0 .3-.15.3-.3v-8.2c0-.15-.15-.3-.3-.3Z"
																class="css-sy7xp0"></path>
                                                            </svg></span>
													<div class="css-84g0ej"></div>
													<span class="css-15zs1or">클래스</span>
												</div>
												<span class="css-8ciuji"><svg
														xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
														class="css-skwyyj">
                                                            <path
				...
				<div class="css-16f3fmi">
						...
						<div class="css-154w5w9" style="display: none;">
							<div class="css-djg42i">
								<div class="css-15zhte1">
									...
									<p class="css-q6q7kk">클래스 판매를 시작할 때, 필수적으로 등록돼야 하는 정보들을 기입해
										주세요.</p>
								</div>
								...
								<div class="css-15zhte1">
									...
									<div class="css-ako7s9">
										<div class="css-1iy9h8i" onclick="notice(7)">
											<div class="css-1f8m7mx">
								...
								<div class="css-xhl235"></div>
								<div class="css-15zhte1">
									<h4 class="css-1o07dsb">정산 정보</h4>
									<div class="css-1pki59g"></div>
									<div class="css-15zhte1">
										<div class="css-79elbk">
											<select required="" class="css-mq3poh">
												<option value="" hidden="" disabled="">클래스를 선택해주세요.</option>
											</select>
											<div class="css-1860z25">
												<span class="css-8ciuji"><svg
														xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
														class="css-uxrfz2">
                                                            <path
					...
					<div class="css-ywnkfc" style="display: none;">
						<div class="css-xc25bh">
							...
							<a href=""><button class="css-9fzpu4">
									<span class="css-3kqv01"><span class="css-1u6oz3l"><svg
												xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
												class="css-1oe6l0y">
                                                        <path
										...
										<span class="css-13g5vis">클래스 만들기</span> </span>
								</button></a>
						</div>
						<div class="css-um3vb4">
							<div class="css-zsf0gj">
								<div class="css-15dlbko">
									<div class="css-1jokisb">
										<!-- <div class="css-1opf2kg">
                                                <div class="css-1mjdx3v">
                                                    <div class="css-yd01oi">
                                                        <form action="">
                                                            <input placeholder="상품명 검색" class="css-en0gic"
                                                                value=""></form>
                                                    </div><span class="css-l67hwq"><svg
                                                            xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                                            class="css-1oe6l0y">
                                                            <path
                                                                d="m22.45 20.7-5.15-5.15A8.41 8.41 0 0 0 19 10.5C19 5.8 15.2 2 10.5 2S2 5.8 2 10.5 5.8 19 10.5 19c1.9 0 3.65-.65 5.05-1.7l5.15 5.15c.1.1.25.1.35 0l1.4-1.4c.1-.1.1-.25 0-.35ZM4.5 10.5c0-3.3 2.7-6 6-6s6 2.7 6 6-2.7 6-6 6-6-2.7-6-6Z"
                                                                class="css-0"></path>
                                                        </svg>
                                                    </span>
                                                </div>
															...
															<span
																...
																<div class="css-1qms59t">
																	<label class="css-165sxpi to" onclick="secc(1)"
																		...
																		</div> <input type="checkbox" class="css-1bcxbx9 all">
																	</label>
																</div>
															</span>
														</div>
															...
															<div aria-rowindex="1" aria-label="row" tabindex="0"
																...
																<div aria-colindex="1"
																	...
																	<div class="css-wzmicz">
																		<label class="css-165sxpi te" onclick="secc(2);"
																			style="cursor: pointer;">
																			<div class="css-d5khiz">
																				<div class="css-1fw7cg7">
																					<span class="css-1e7z94r"> <svg
																			...
																			</div> <input type="checkbox" class="css-1bcxbx9 term">
																		</label>
																	</div>
																</div>
																<div aria-colindex="2"
							...
							<div class="css-1aszr8r" style="display: none;">
								<div class="css-zsoya5">
									<div class="css-1mjdx3v">
										<div class="css-yd01oi">
											<form action="">
												<input placeholder="클래스명 검색" class="css-en0gic" value="">
											</form>
										</div>
										<span class="css-l67hwq"><svg
												xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
									...
									<div class="css-fl7ryc">
										<div class="css-fn3iy8">
											<p class="css-1bu2vuc">최근 생성일순</p>
											<div class="css-kna7wq"></div>
											<span class="css-ujih8e"><svg
													xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
													class="css-skwyyj">
										...
										<button class="css-1iuy7k3">
											<span class="css-3kqv01"><span class="css-1u6oz3l"><svg
														xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
														class="css-1oe6l0y">
                                                                <path
															d="m1.07 9.83 1.415-1.415c.1-.1.255-.1.355 0l7.155 7.155 11.16-11.16c.1-.1.255-.1.355 0l1.415 1.415c.1.1.1.255 0 .355l-12.75 12.75c-.1.1-.255.1-.355 0l-8.75-8.745a.257.257 0 0 1 0-.355Z"
															class="css-1b224fx"></path>
                                                            </svg></span>
												<div class="css-1gxj1fi"></div>
												<span class="css-13g5vis">선택</span> </span>
										</button>
									</div>
									<div class="css-10o014q">
										<div class="css-7vhjou"></div>
										<div
											class="css-1dbjc4n r-150rngu r-eqz5dr r-16y2uox r-1wbh5a2 r-11yh6sk r-1rnoaur r-1sncvnh"
											style="flex: 1 1 0%;">
											<div class="css-1dbjc4n">
												<div class="css-1dbjc4n">
													<div class="css-1dbjc4n" style="flex: 1 1 0%;">
														<div class="css-1d4b7ti">
															<div class="css-1r96u7t">
																<div class="css-1m6hr3p">
																	<div class="css-14dbzi9">
																	...
																	<div class="css-1lg6qbs">
																		<p class="css-1y55gog">클래스명을 입력해주세요.</p>
																		<div class="css-uqt4j8"></div>
																		<div class="css-1k81e3v">
																			<div class="css-imdqfq">
																				<div class="css-b83688">
																					<div class="css-q9e5d2"></div>
																					<div class="css-iiuncx"></div>
																					<p class="css-hrg016">수요조사 준비</p>
																			...
																			<p class="css-1rgrmv3">･ 정규 클래스 ･ 비공개</p>
																		</div>
																	</div>
																</div>
															</div>
					...
					<!-- 클래스 댓글 관리 -->
					<div class="Spacing__Box-sc-47wgmh-0 fvDAgv" style="display: none;">
						<div
							class="Grid__StyledDiv-sc-81d45n-0 iIwnuy KlassCommentManagementViewContoller__StyledGrid-sc-1yz7twk-1 vNEzr">
							<section>
								<header
									class="SectionWithActionComponentInHeader__Header-sc-4czxaj-0 fVeHBb">
									<div
										class="SectionWithActionComponentInHeader__HeaderLeftContent-sc-4czxaj-2 eWJgrv">
										<h1 font-weight="bold"
											class="BaseTypography__TextElement-sc-8ucuwh-0 fmoJbA">클래스
											댓글 관리</h1>
									</div>
								</header>
								<div
									class="SectionWithActionComponentInHeader__Content-sc-4czxaj-3 fmcBpP">
									<div
										class="KlassCommentManagementViewContoller__ProductSelectContainer-sc-1yz7twk-0 jOGrTM">
										<select color="#3a3a3a" fill="true"
											class="SelectInput__StyledSelect-dwrbad-0 iaGOOp">
											<option value="" hidden="" disabled="">클래스를 선택해주세요</option>
											<option value="6289311c00bc9c000e0bd7d3">제목 없음</option>
										</select>
									</div>
									<div class="css-x4nqnm">
										<div class="css-ys0qfa">
											<picture class="css-4rx3j2">
											<source type="image/webp"
												srcset="https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/640xauto.webp 640w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/750xauto.webp 750w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/828xauto.webp 828w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/1080xauto.webp 1080w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/1200xauto.webp 1200w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/1920xauto.webp 1920w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/2048xauto.webp 2048w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/3840xauto.webp 3840w">
											<img alt=""
												srcset="https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/640xauto 640w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/750xauto 750w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/828xauto 828w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/1080xauto 1080w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/1200xauto 1200w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/1920xauto 1920w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/2048xauto 2048w,https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4/3840xauto 3840w"
												src="https://cdn.class101.net/images/6db175e0-341d-43cd-bf7a-565916c3e2f4"
												class="css-1ms1fm5"> </picture>
											<div class="css-oor4vx"></div>
											<div class="css-194e0q9">
												<h6 class="css-1x7csa1">작성된 클래스 댓글이 없어요.</h6>
											</div>
										</div>
									</div>
								</div>
