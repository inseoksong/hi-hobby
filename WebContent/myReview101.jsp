...
<link rel="stylesheet" href="asset/css/myReview101.css">
		...
		<div id="wrapper">
			<div class="wrapper2">
				...
				<div class="css-um3vb4">
					<div class="css-127jwgl">
						<ol class="css-58su99">
							<li>
								<p class="css-19h48vc" >
									<a onclick="location.href='myPage101.jsp'">
										<div class="css-1yf2cr2">
											<p class="css-kk39n">마이페이지</p>
										</div>
									</a>
								</p>
							</li>
							<div class="css-1197pxv"></div>
							<div class="css-1197pxv"></div>
							<div class="lkWmez"></div>
							<li>
								<p class="css-1btxw89">
									<a><div class="css-1yf2cr2"><p class="css-rvyty7">내 후기</p></div></a>
								</p>
							</li>
						</ol>
						...
						<p class="css-1zp0qa">
							클래스를 30% 이상 수강하면 후기를 작성하실 수 있어요.
							<br>
							사진, 영상과 함께 최대 2,500포인트를 적립 받아보세요.
						</p>
						<div class="css-ltdizj"></div>
						<div class="css-zsoya5"></div>
						<div class="css-em1vzn"></div>
					</div>
				</div>
